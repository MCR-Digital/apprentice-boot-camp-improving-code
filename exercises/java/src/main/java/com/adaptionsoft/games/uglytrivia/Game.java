...
public class Game {
    ...
    private String currentCategory() {
        ...
        if (placeOnBoardOfCurrentPlayer % 4 == 0) return QuestionCategories.POP.getCategory();
        if (placeOnBoardOfCurrentPlayer % 4 == 1) return QuestionCategories.SCIENCE.getCategory();
        if (placeOnBoardOfCurrentPlayer % 4 == 2) return QuestionCategories.SPORTS.getCategory();
        if (placeOnBoardOfCurrentPlayer % 4 == 3 || placeOnBoardOfCurrentPlayer == 10) return QuestionCategories.ROCK.getCategory();
        return null;
    }
